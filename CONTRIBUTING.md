# Contributing to gautocloud-connectors

We'd love for you to contribute to our source code and to make the gautocloud-connectors even better than it is today!
...
In Github, send a pull request to original master branch: f.e. `gautocloud-connectors:master`.
...
[github]: https://github.com/philips-software/gautocloud-connectors/issues 
